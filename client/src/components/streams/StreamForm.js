...
//les 267
//all of streamcreate stuff is now here now from les 267
class StreamForm extends React.Component{
    ...
    onSubmit = (formValues) =>{
        ...
        //you are using this.props bc you have wired the action creator into the react x    

        //les 269 - this used to be this.props.createStreams(formValues)
        //so since you take out this.props.createStreams, you need to replace it with something else 
